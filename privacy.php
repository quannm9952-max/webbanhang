    ...
    <div class="row justify-content-center">
        <div class="col-lg-9">
            <div class="bg-white p-5 rounded-4 shadow-sm border">
                <h1 class="fw-800 mb-4 display-6">Chính sách bảo mật</h1>
                ...
                <div class="content-section" style="line-height: 1.8; color: #334155;">
                    ...
                    <ul>
                        ...
                        <li>Gửi các thông báo về khuyến mãi, cập nhật sản phẩm (nếu khách hàng đồng ý).</li>
                    </ul>

                    <h4 class="fw-bold text-dark mt-4 mb-3">2. Phạm vi thu thập thông tin</h4>
                    <p>Các thông tin chúng tôi thu thập bao gồm:</p>
                    <ul>
                        <li>Họ và tên, địa chỉ email, số điện thoại liên lạc.</li>
                        <li>Địa chỉ giao hàng.</li>
                        <li>Lịch sử mua sắm và các đánh giá sản phẩm.</li>
                    </ul>
                    ...
                    <h4 class="fw-bold text-dark mt-4 mb-3">5. Cam kết bảo mật</h4>
                    <p>Mọi thông tin giao dịch được mã hóa và bảo vệ an toàn. Chúng tôi áp dụng các công nghệ bảo mật tiên tiến nhất để ngăn chặn việc truy cập trái phép.</p>
                </div>
            </div>
        </div>
    </div>
